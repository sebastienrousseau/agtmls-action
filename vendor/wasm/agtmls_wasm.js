/* @ts-self-types="./agtmls_wasm.d.ts" */
...
function audit(name, content) {
    ...
    const ret = wasm.audit(ptr0, len0, ptr1, len1);
    if (ret[2]) {
 ...
 * @returns {any}
 */
function audit_skill(files) {
    const ret = wasm.audit_skill(files);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
}
exports.audit_skill = audit_skill;
...
function normalise(content) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.normalise(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 */
function rule_count() {
    const ret = wasm.rule_count();
    return ret >>> 0;
}
exports.rule_count = rule_count;
 ...
 */
function rule_ids() {
    const ret = wasm.rule_ids();
    var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]);
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v1;
}
exports.rule_ids = rule_ids;
 ...
 * @returns {string}
 */
function skill_digest(files) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.skill_digest(files);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
...
exports.skill_digest = skill_digest;
...
const wasmPath = `${__dirname}/agtmls_wasm_bg.wasm`;
